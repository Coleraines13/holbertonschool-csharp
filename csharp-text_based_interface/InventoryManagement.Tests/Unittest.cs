...
namespace Tests
{
	public class Tests
	{
		...
		public List<string> ListUsers = new List<string>() { "Amine", "Leila", "Ahmed", "Amine", "salah", "mostafa", "Foued" };
		public List<string> ListItems = new List<string>() { "shoes", "shirt", "pool", "cat", "dog", "strawberry", "lemon" };
